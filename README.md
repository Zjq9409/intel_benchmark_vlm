...
bash setup_env.sh --weights-dir /data/weights/ --intel-image intel/llm-scaler-vllm:0.18.0-xpu

# 指定 NV Docker 镜像
bash setup_env.sh --weights-dir /data/weights/ --nv-image vllm/vllm-openai:v0.20.0-cu130
