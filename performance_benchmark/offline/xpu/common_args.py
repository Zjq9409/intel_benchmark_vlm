...
def parse_args():
    ...
    parser.add_argument("--model-path", type=str, default="/llm/models/Qwen3-Omni-30B-A3B-Instruct")
    parser.add_argument("--imgs-path", type=str, default="/llm/models/tmp_bb/")
    parser.add_argument("--batch", type=int, default=2)
    parser.add_argument("--dtype", type=str, default="float16", choices=["float16", "bfloat16", "float32"], help="Data type for model")
    parser.add_argument("--max-model-len", type=int, default=14000, help="Maximum model sequence length")
    parser.add_argument("--tensor-parallel-size", type=int, default=4, help="Number of GPUs for tensor parallelism")
    parser.add_argument("--max-num-batched-tokens", type=int, default=8192, help="Maximum number of batched tokens")
    parser.add_argument("--gpu-memory-utilization", type=float, default=0.9, help="GPU memory utilization (0.0-1.0)")
    parser.add_argument("--block-size", type=int, default=64, help="KV cache block size")
    parser.add_argument("--quantization", type=str, default="fp8", choices=["fp8", "fp16", "none"], help="Quantization method")
    ...
    parser.add_argument('--hf-model-dir',
                        type=str,
                        default="/llm/models/Qwen2-VL-7B-Instruct",
